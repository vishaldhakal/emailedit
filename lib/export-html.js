...
" />`;
  ...
  >
    ...
    case "list":
      if (component.data.listType === "unordered") {
        return `<div style="color: ${component.data.color}; font-size: ${
          component.data.fontSize
        };">
      <ul style="list-style-type: ${component.data.listStyle}; ">
        ${component.data.items.map((item) => `<li>${item}</li>`).join("\n")}
      </ul>
    </div>`;
      } else if (data.listType === "ordered") {
        return `<div style="color: ${component.data.color}; font-size: ${
          component.data.fontSize
        };">
      <ol style="list-style-type: ${component.data.listStyle}; ">
        ${component.data.items.map((item) => `<li>${item}</li>`).join("\n")}
      </ol>
    </div>`;
      }
