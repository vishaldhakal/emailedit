...
function componentToHtml(component) {
  switch (component.type) {
    case "text-block":
      return `<div style=" margin-bottom: 16px; padding-left: 0.5rem; padding-bottom: 0.25rem; width: 100%; border: none; outline: none; font-size: ${component.data.fontSize};font-family:${component.data.font}; text-align: ${component.data.alignment}; background-color:${component.data.backgroundColor};letter-spacing:${component.data.letterSpacing}px; line-height:${component.data.lineHeight}; ">${component.data.content}</div>`;
    case "heading":
      return `<${
